...
std::vector<cv::String> listFiles(const std::string& dirName, const std::vector<std::string>& extensions, bool relative=true); //Lists all files in dirName with extensions.
